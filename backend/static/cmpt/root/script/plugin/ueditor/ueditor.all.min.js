...
(b.customDomain&&document.domain!=location.hostname?'document.domain="127.0.0.1'+document.domain+'127.0.0.1"127.0.0.1':"")+'127.0.0.1"'+c+'");document.close();}())'}));a.style.overflow="hidden";setTimeout(function(){/%$/.test(b.initialFrameWidth)&&(b.minFrameWidth=b.initialFrameWidth=a.offsetWidth,a.style.width=b.initialFrameWidth+"px");/%$/.test(b.initialFrameHeight)&&(b.minFrameHeight=b.initialFrameHeight=a.offsetHeight,a.style.height=b.initialFrameHeight+"px")})}},_setup:function(a){var b=this,c=b.options;E?(a.body.disabled=
...
ol:d,ul:d,dl:d,dt:d,dd:d,li:d,caption:a,th:a,tr:a,h1:a,h2:a,h3:a,h4:a,h5:a,h6:a,td:function(a){a.innerText()&&a.parentNode.insertAfter(UE.uNode.createText(" &nbsp; &nbsp;"),a);a.parentNode.removeChild(a,a.innerText())}}}()});var e=this.options.pasteplain;this.commands.pasteplain={queryCommandState:function(){return e?1:0},execCommand:function(){e=!e|0},notNeedUndo:1}};UE.plugins.video=function(){function f(a,b,e,g,k,l){return l?'<embed type="application/x-shockwave-flash" class="edui-faked-video" pluginspage="../../www.macromedia.com/go/getflashplayer" src="'+
...
this.addListener("keydown",function(f,a){var d=this.selection.getRange();d.collapsed||(a.ctrlKey||a.metaKey||a.shiftKey||a.altKey)||(d=e.findParent(d.startContainer,function(a){if(a.className&&e.hasClass(a,"ue_t"))return a},!0))&&e.removeClasses(d,["ue_t"])})};UE.plugins.music=function(){function f(a,b,e,g,f,l){return f?'<embed type="application/x-shockwave-flash" class="edui-faked-music" pluginspage="../../www.macromedia.com/go/getflashplayer" src="'+a+'" width="'+b+'" height="'+e+'" align="'+g+
...
(g="webappDialog");-1!=f.src.indexOf("../../api.map.baidu.com")&&(g="mapDialog");-1!=f.className.indexOf("edui-faked-music")&&(g="musicDialog");-1!=f.src.indexOf("../../maps.google.com/maps/api/staticmap")&&(g="gmapDialog");f.getAttribute("anchorname")&&(g="anchorDialog",d=h.formatHtml("<nobr>"+c.getLang("property")+': <span onclick=$$._onImgEditButtonClick("anchorDialog") class="edui-clickable">'+c.getLang("modify")+"</span>&nbsp;&nbsp;<span onclick=$$._onRemoveButtonClick('anchor') class=\"edui-clickable\">"+
