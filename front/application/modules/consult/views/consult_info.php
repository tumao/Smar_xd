...
<div class="xtmain">
    ...
    <div class="col01box fl">
        ...
        <div class="alljsbox">
            ...
            <div class="jzallmap">
                <ul class="">
                  <p style="font-size:18px; margin:0 auto; width:350px;"><?php echo $info['title']; ?> </p>
                  <p style="width:200px;font-size:12px; margin:0 auto;"><?php echo $info['ctime']; ?></p>
                  <div style="border-top:1px solid gray; padding:10px;"><?php echo $info['content']; ?></div>
                </ul>
            </div>
