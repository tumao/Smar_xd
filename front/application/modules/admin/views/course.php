...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <h3 class="smaller lighter blue" style="display: inline;">信托课堂列表</h3>
            ...
            <tr>
                ...
                <td>
                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                        ...
                        <a class="green" href="/redbud_admin/upsertcourse?cid=<?php echo $result[$i]['id']; ?>">
