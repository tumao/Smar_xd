;(function($) {
    ...
    $.fn.jfz_animation_slider = function(options) {
        ...
        return this.each(function() {
            ...
            orbit.add(orbitWidth).width('548px').height('272px');
            ...
            if(options.timer) {         	
                ...
                if(timer.length != 0) {
                    var rotator = $('div.timer span.rotator'),
                    	mask = $('http://www.jinfuzi.com/static/plugin/JFZ_Slider/js/div.timer span.mask'),
            ...
            if(options.directionalNav) {
                ...
                var directionalNavHTML = '<div class="slider-nav"><span class="right clearfix"><i class="f_fl icon_right"></i></span><span class="left clearfix"><i class="f_fl icon_left"></i></span></div>';
                orbitWrapper.append(directionalNavHTML);
                var leftBtn = orbitWrapper.children('div.slider-nav').children('http://www.jinfuzi.com/static/plugin/JFZ_Slider/js/span.left'),
            ...
            var $slider_nav = orbitWrapper.find(".slider-nav"),
            	$slider_span = $slider_nav.find("span");
            	
            orbitWrapper.hover(function(){
            	$slider_span.show();
            },function(){
            	$slider_span.hide();
            });
